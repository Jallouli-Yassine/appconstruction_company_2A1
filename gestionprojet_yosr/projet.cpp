...
Projet::Projet(QString localisation,QString idarchitecte,QString reference,QString prix_totale)
{
...
bool Projet::ajouter()
{
    ...
    query.prepare("insert into PROJET(LOCALISATION,IDARCHITECTE,REFERENCE,PRIX_TOTALE)"
                  "values(upper(:LOCALISATION),:IDARCHITECTE,upper(:REFERENCE),:PRIX_TOTALE)");
