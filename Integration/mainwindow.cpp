...
//*Bayoudh*//
   ...
   ui->verticalLayout_21->addWidget(Ac.stat());
...
void MainWindow::on_ajouter_clicked()
{
    ...
    Architect Ac(id,nom,prenom,ntel,email,etat);

    bool test=Ac.ajouter();
    if(test)
    {
...
void MainWindow::on_supprimer_2_clicked()
{
    ...
    Ac.setid(ui->idd->text().toInt());
   bool test=Ac.supprimer(Ac.getid());
   if(test)
...
void MainWindow::on_modifierarchitect_clicked()
{
    QMessageBox msgBox;
...
void MainWindow::on_pushButtonrechdech_2_clicked()
{
    QMessageBox msgBox;
      ...
      ui->education->setModel(Ac.chercher(nom));
...
void MainWindow::on_pushButtonAfficherDech_2_clicked()
{
   ...
   // qDebug()<< attribute ;
 //   qDebug()<< croissance ;
    ui->education->setModel(Ac.trie(attribute,croissance));
}
